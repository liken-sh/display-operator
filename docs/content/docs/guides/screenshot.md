---
title: Take a picture of a screen
weight: 40
...
You need the operator [installed](/docs/guides/install/) on your
[`liken`](https://liken.sh/docs/) cluster and a connected
[`Display`](/docs/reference/displays/).
...
the caller as it is made. The [API reference](/docs/reference/api/)
