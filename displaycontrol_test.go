...
// A darkening that landed opens the wire no further. A DDC
// read is a wake stimulus on some panels, and a pass that read a
// darkened panel could relight the screen the override holds dark.
